@REM C:\tools\openmsx20\openmsx.exe -machine Sanyo_phc-70FD -cart rom/viott.rom -romtype ASCII16 -command "debug set_watchpoint read_io 0x2E" -command "set throttle off" -command "after time 7 {set throttle on}"
@REM C:\tools\openmsx20\openmsx.exe -machine Sanyo_phc-70FD2 -cart rom/viott.rom -romtype ASCII16 -command "debug set_watchpoint read_io 0x2E" -command "set throttle off" -command "after time 7 {set throttle on}"
...
C:\tools\openmsx20\openmsx.exe -machine Panasonic_FS-A1ST -cart rom/viott.rom -romtype ASCII16 -command "debug set_watchpoint read_io 0x2E" -command "set throttle off" -command "after time 7 {set throttle on}"

@REM C:\tools\openmsx20\openmsx.exe -machine Panasonic_FS-A1WSX -cart rom/viott.rom -romtype ASCII16 -command "debug set_watchpoint read_io 0x2E" -command "set throttle off" -command "after time 7 {set throttle on}"
