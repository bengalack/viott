...
C:\tools\openmsx20\openmsx.exe -machine Philips_NMS_8255 -cart rom/viott.rom -romtype ASCII16 -command "debug set_watchpoint read_io 0x2E" -command "set throttle off" -command "after time 7 {set throttle on}"
