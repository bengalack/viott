...
C:\tools\openmsx20\openmsx.exe -machine Panasonic_FS-A1ST -diska dska/ -command "debug set_watchpoint read_io 0x2E" -command "set throttle off" -command "after time 7 {set throttle on}"
