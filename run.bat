...
C:\tools\openmsx20\openmsx.exe -machine Sanyo_phc-70FD2 -diska dska/ -command "debug set_watchpoint read_io 0x2E" -command "set throttle off" -command "after time 7 {set throttle on}"
...
@REM C:\tools\openmsx20\openmsx.exe -machine Panasonic_FS-A1ST -diska dska/ -command "debug set_watchpoint read_io 0x2E" -command "set throttle off" -command "after time 7 {set throttle on}"
